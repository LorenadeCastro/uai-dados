...
LINHAS   TOTAL
         nivel1_rec > nivel2_rec > nivel3_rec > fonte_cod > receita_desc
...
def pagina():
    return Pagina(
        titulo="Receita Fiscal",
        descricao=(
            f"Exercício de referência {ANO_REF}. Arrecadação dos exercícios "
            "anteriores, previsão da LOA, reestimativa vigente e arrecadação corrente."
        ),
        bases={
            "exec_rec": exec_rec,
            "loa_rec": loa_rec,
        ...
        filtros=[
            ...
            Filtro("Código da Receita", coluna="receita_cod"),
        ...
        componentes=[
            Matriz(
                ...
                rotulos={
                    ...
                    "nivel3_rec": "Espécie",
                    "fonte_cod": "Fonte",
                    "receita_desc": "Natureza da Receita",
                },
                niveis_visiveis=1,
                colunas=[
